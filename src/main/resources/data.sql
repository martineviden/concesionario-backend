...
('0120NBB', 9, 'Verde', 6000, TRUE, 'MADRID', 'GASOLINA', 'C', NULL, 5, TRUE, 5, 'MANUAL'),
('1111AAA', 8, 'Rojo', 15000, TRUE, 'ZARAGOZA', 'GASOLINA', 'C', NULL, 0, FALSE, 2, 'MANUAL'),
...
('2222BBB', 7, 'Negro', 25000, FALSE, 'MALAGA', 'GASOLINA', 'B', NULL, 0, FALSE, 2, 'MANUAL'),
('2345PQR', 6, 'Gris', 18000, TRUE, 'ALICANTE', 'GASOLINA', 'ECO', NULL, 5, TRUE, 5, 'AUTOMATICO'),
('3434LLL', 19, 'Rojo', 4500, TRUE, 'BURGOS', 'GASOLINA', 'C', NULL, 5, TRUE, 5, 'MANUAL'),
('3456JKL', 4, 'Azul', 22000, FALSE, 'SEVILLA', 'GASOLINA', 'C', NULL, 0, FALSE, 2, 'MANUAL'),
('4444DDD', 11, 'Gris', 12000, TRUE, 'GRANADA', 'GASOLINA', 'ECO', NULL, 5, TRUE, 5, 'MANUAL'),
('4556EEE', 12, 'Negro', 7000, TRUE, 'CANTABRIA', 'GASOLINA', 'C', NULL, 5, TRUE, 5, 'MANUAL'),
('5656MMM', 20, 'Verde', 32000, TRUE, 'ASTURIAS', 'DIESEL', 'C', NULL, 5, TRUE, 5, 'MANUAL'),
('5678DEF', 2, 'Negro', 8000, TRUE, 'BARCELONA', 'GASOLINA', 'C', NULL, 5, TRUE, 5, 'MANUAL'),
...
('7890MNO', 5, 'Amarillo', 3000, TRUE, 'BALEARES', 'GASOLINA', 'C', NULL, 5, TRUE, 5, 'MANUAL'),
('8888HHH', 15, 'Blanco', 22000, TRUE, 'VALENCIA', 'GASOLINA', 'C', NULL, 5, TRUE, 5, 'MANUAL'),
('8999III', 16, 'Negro', 9000, TRUE, 'TOLEDO', 'GASOLINA', 'B', NULL, 5, TRUE, 5, 'MANUAL'),
('9012GHI', 3, 'Blanco', 45000, TRUE, 'VALENCIA', 'DIESEL', 'C', NULL, 3, TRUE, 3, 'MANUAL'),
('9999III', 16, 'Negro', 9000, TRUE, 'TOLEDO', 'GASOLINA', 'B', NULL, 5, TRUE, 5, 'MANUAL'),
...
('C789DEF', 5, 'Negro', 5000, TRUE, 'VALENCIA', 'GASOLINA', 'C', NULL, 5, TRUE, 5, 'MANUAL'),
('D012EFG', 5, 'Azul', 3000, TRUE, 'SEVILLA', 'GASOLINA', 'C', NULL, 5, TRUE, 5, 'MANUAL'),
